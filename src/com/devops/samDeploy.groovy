...
def samDeploy() {
    ...
    sh '''
        ...
        sam deploy -t template.yaml --stack-name=$stack_name --region=$region --no-fail-on-empty-changeset --capabilities CAPABILITY_IAM --parameter-overrides $SAM_PARAMETERS --tags Key=Name,Value=$stack_name
